...
**Answer: True, the distributions should be similar but not exactly the same.**
...
**Answer -3. The sample distribuion must be nearly normal dooes not have to be true**
...
**Answer 1. 95% of the time the true average area of houses in Ames, Iowa, will be in this interval.**
...
**The true average size of houses are captured in our 95% confidence level**
